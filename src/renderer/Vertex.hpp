...
struct Vertex {
    ...
    static eastl::array<vk::VertexInputAttributeDescription, 4> getAttributeDescriptions() {
        eastl::array<vk::VertexInputAttributeDescription, 4> attributeDescriptions{};
