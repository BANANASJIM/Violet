...
struct LightComponent {
    ...
    float shadowFarPlane = 5000.0f;              // Far plane for shadow projection (larger range for CSM)
    ...
    float cascadeSplitLambda = 0.5f;             // Practical split scheme lambda (0.0=uniform, 1.0=logarithmic, 0.5-0.9=recommended)
